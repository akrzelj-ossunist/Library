...
public interface AuthorController {
     ...
     **/
    ResponseEntity<Author> create(AuthorDto authorDto) throws ObjectDoesntExistException, AlreadyExistException, InvalidArgumentsException, InvalidAuthorException;
     ...
     **/
    ResponseEntity<Author> edit(String authorId, AuthorDto authorDto) throws ObjectDoesntExistException, AlreadyExistException, InvalidArgumentsException, InvalidAuthorException;
    ...
    ResponseEntity<Author> authorProfile(String authorId) throws ObjectDoesntExistException, InvalidArgumentsException;
    ...
    ResponseEntity<List<Author>> filterList(Map<String, String> allParams) throws InvalidArgumentsException;
}
